		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HW_Title",
									"targetURL": "#comsapfioriprojecthw-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapfioriprojecthw-display": {
								"semanticObject": "comsapfioriprojecthw",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=comsapfiori.projecthw",
									"url": sap.ui.require.toUrl("comsapfiori/projecthw")
								}
							}
						}
					}
