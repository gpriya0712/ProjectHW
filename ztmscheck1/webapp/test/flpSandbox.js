		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori",
									"targetURL": "#comsapfioriztmscheck1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapfioriztmscheck1-display": {
								"semanticObject": "comsapfioriztmscheck1",
								"action": "display",
								"description": "Fiori",
								"title": "Fiori",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=comsapfiori.ztmscheck1",
									"url": sap.ui.require.toUrl("comsapfiori/ztmscheck1")
								}
							}
						}
					}
